...
<head>
    ...
    @yield('dataTable')
    <title>Forgefit Flow</title>
    <link rel="icon"  type="images/x-icon" href="{{ asset('/imgs/gym-title-icon.png') }}" />
</head>
<style>
.fa,
.fas,
...
<body class="sidebar-collapse">
    ...
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="font-size: 14px; background-color: rgb(54, 16, 16) ; border: none;  ">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
            @role('admin|cityManager|gymManager')
            <li class="nav-item">
                <a class="nav-link text-white" data-widget="pushmenu" href="#" role="button" id="asideIcon"><i
            ...
            <li class="dropdown user user-menu" style="cursor:pointer;">
                <div class="media align-items-center">
                    <img src="{{asset(auth()->user()->profileImageFile)}}" alt="User Avatar"
                        class="mr-2 mt-1 img-size-32 img-circle ">
                ...
                <ul class="dropdown-menu" style="width:200px">
                    ...
                    <li class="user-footer d-flex justify-content-between " style="border-radius: 50px">
                        <div class="pull-left">
    ...
    @role('admin|cityManager|gymManager')
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="font-size: 14px;width: 200px;">
            ...
            <a href="{{ route('welcome') }}" class="brand-link px-2">
                <span class="brand-text font-weight-light px-4">Forgefit Flow</span>
            </a>
            <!-- Sidebar -->.
            <div class="sidebar">
    ...
    <footer class="main-footer d-flex justify-content-center" style="font-size:13px; background-color: rgb(54, 16, 16);border: none;">
        <span class="rounded-lg px-2 py-1 text-white">Forgefit Flow</span>
    </footer>
    <!-- jQuery -->
